...
export default function LikedQuotesPage() {
  ...
  // Sadece isLiked değeri true olan sözleri ve orijinal indexlerini filtreleyip alıyoruz
      ...
      <div className='flex flex-col gap-4 w-full max-w-2xl'>
        {likedQuotes.length === 0 ? (
          ...
          likedQuotes.map((item) => (
            <section key={item.originalIndex} className='bg-slate-50/50 rounded-md p-6 flex justify-between items-center shadow-sm'>
